import 'package:bhai_goa_chalte_hai/controllers/menu_controller.dart';
...
class NavBar extends StatelessWidget {
  ...
  final navLinks = [ "Bakchodi", "TODO", "OmicronKMKB","Travel"];
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              Text("Bhai Goa chalte hai", style: TextStyle(fontSize: 26))
            ],
          ),
          // Responsive Layout
